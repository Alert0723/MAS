    ...
    public partial class OutPut : MetroWindow
    {
        ...
        private void ToNBT_Click(object sender, RoutedEventArgs e)
        {
            ...
            if ((bool)StructureFile.ShowDialog())
            {
                ...
                //数据导出
                CreateNBT.CreateStructure(MainPage.k, MainPage.Max_length, MainPage.Portrait, MainPage.commands, MainPage.Flat, "Minecraft Adaptable Studio", ref MainPage.StructureNbt);
                var NBTFile = new NbtFile(MainPage.StructureNbt);
